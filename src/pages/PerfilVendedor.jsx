...
export default function PerfilVendedor() {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      {/* Header del perfil */}
      <div className="bg-slate-900 border-b border-slate-800 px-6 py-12">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-6">
          
          {/* Avatar */}
          <div className="w-24 h-24 rounded-full bg-cyan-500/20 flex items-center justify-center text-cyan-400 font-black text-4xl flex-shrink-0">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-slate-400 mb-4">📍 {perfil.ciudad}</p>
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        <h2 className="text-xl font-bold text-white mb-6">Publicaciones</h2>
